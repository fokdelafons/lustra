...
function buildMainTopicsUrl(lang) {
    return `https://lustra.news/${lang}/${config.URL_PREFIX.institution}/topics/`;
}

module.exports = { buildBillUrl, buildHubUrl, buildTopicUrl, buildMainTopicsUrl };