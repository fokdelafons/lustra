...
class Legislation {
  ...
  final missingDataInfoData = json['missingDataInfo'];
    ...
    return Legislation(
      ...
      title: _parseDynamicString(json['title'], fieldName: 'title', itemId: itemIdForLog) ?? 'Brak tytułu',
      description: _parseDynamicString(json['description'], fieldName: 'description', itemId: itemIdForLog) ?? 'Brak opisu',
      status: _parseDynamicString(json['status'], fieldName: 'status', itemId: itemIdForLog) ?? 'Nieznany',
